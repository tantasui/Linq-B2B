...
const footerLinks = {
  Product: ["Payment Links", "Crypto Invoicing", "API", "Integrations", "Pricing"],
...
export function Footer() {
  return (
    <footer id="docs" className="bg-black border-t border-white/5">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-3">
              {[
                ...
                "https://cryptologos.cc/logos/arbitrum-arb-logo.svg?v=040",
                "https://cryptologos.cc/logos/tron-trx-logo.svg?v=040",
                "https://cryptologos.cc/logos/bnb-bnb-logo.svg?v=040",
              ].map((logo, i) => (
                <div key={i} className="w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center">
                  <Image src={logo} alt="chain" width={16} height={16} unoptimized />
                </div>
              ))}
            </div>
          </div>
